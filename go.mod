module github.com/mikebz/bubblechat

go 1.24.3

require (
	github.com/GoogleCloudPlatform/kubectl-ai v0.0.11
...
require (
	...
	github.com/GoogleCloudPlatform/kubectl-ai/gollm v0.0.0-20250528173919-0442b4a6646b // indirect
